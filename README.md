...
| `dailyActiveChallenge` | 每日主动挑战次数 | 1 |
...
- **2025-07 平衡调整**：饰品 ATK/MDEF 下调至同级最强武器的 30% 以下，DEF/MDEF 下调至同级最强防具的 30% 以下，避免饰品数值碾压武器和防具
...
**简单说**：这是我做给自己家用的玩具项目，能用，但别期待太高。觉得哪里不好，自己改改就行。
...
- 🐛 **特效解析修复**：修复了含"全属性+X%"的装备，逗号后特效未生效的问题
- 📚 **百科全书同步**：装备数据与主游戏同步更新
